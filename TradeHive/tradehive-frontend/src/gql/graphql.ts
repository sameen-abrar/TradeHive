...
/** XXXAll built-in and custom scalars, mapped to their actual values */
export type Scalars = {
...
export type GetAllQuery = { __typename?: 'Query', getAllProducts?: Array<{ __typename?: 'ProductListResponse', title: string, description: string, price: number, rentPrice: number, rentType?: string | null, categories: Array<string>, createdAt: string } | null> | null };
...
export type GetProductByIdQuery = { __typename?: 'Query', getProduct?: { __typename?: 'productResponseModel', title: string, description: string, price: number, rentPrice: string, rentType: string, categories?: Array<string> | null, createdAt?: any | null } | null };
